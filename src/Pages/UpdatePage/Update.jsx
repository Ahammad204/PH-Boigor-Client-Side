    ...
    <div>
      <div className=" p-10">
        ...
        <form onSubmit={handleUpdateBook} className="mt-4">
          ...
          <div className="md:flex mb-8">
            ...
            <div className="form-control md:w-1/2 ml-4">
              ...
              <select
                ...
                required
                className="select w-full outline-2 outline-black"
              >
            ...
            <div className="form-control md:w-1/2 ml-4">
              ...
              <label className="input-group">
                <input
                  type="text"
                  required
                  defaultValue={Updated?.AuthorsName}
                  name="AuthorsName"
          ...
          <div className="mb-8">
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <textarea
                  type="text"
                  defaultValue={Updated?.bookContent}
                  required
                  name="bookContent"
                  placeholder="Enter Some Book Content"
          ...
          <input
            className="btn btn-block text-white bg-[#E59285] hover:bg-[#E59285] "
            type="submit"
            value="Add Book"
          />
        </form>
